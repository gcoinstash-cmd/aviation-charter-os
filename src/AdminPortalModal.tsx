...
export const AdminPortalModal: React.FC<AdminPortalModalProps> = ({ isOpen, onClose }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    e.preventDefault();
    if (passcode.toLowerCase() === 'aviation2026') {
      ...
      <div className="relative w-full max-w-4xl bg-[#121214] border border-amber-500/30 rounded-2xl p-6 sm:p-8 shadow-2xl text-zinc-100 max-h-[90vh] overflow-y-auto">
        ...
        {!isAuthenticated ? (
          <div className="py-8 max-w-md mx-auto text-center">
            ...
            <h3 className="text-2xl font-bold tracking-tight mb-2">AVIATION CHARTER OS Command</h3>
            ...
            <form onSubmit={handleLogin} className="space-y-4">
              <div>
                <input
                  ...
                  placeholder="Enter dispatch passkey (aviation2026)"
              ...
              {error && (
                <p className="text-red-400 text-xs font-mono">Invalid passkey. Use: aviation2026</p>
              )}
          ...
          <div>
            <div className="flex flex-wrap items-center justify-between gap-4 border-b border-zinc-800 pb-6 mb-6">
              <div>
                ...
                <h3 className="text-xl font-bold text-white">AVIATION CHARTER OS // BACK-OFFICE</h3>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 rounded-xl bg-zinc-900/60 border border-zinc-800">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
                      ...
                      <div key="aircraft_fleet" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>aircraft_fleet</span>
                      </div>
                    
                      <div key="charter_bookings" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>charter_bookings</span>
                      </div>
                    
                      <div key="empty_legs" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>empty_legs</span>
                      </div>
                    
                      <div key="vip_manifests" className="p-2.5 rounded bg-zinc-950 border border-zinc-800 text-xs font-mono text-zinc-300 flex items-center gap-1.5">
                        <CheckCircle className="w-3.5 h-3.5 text-emerald-400 flex-shrink-0" />
                        <span>vip_manifests</span>
                      </div>
            ...
            {activeTab === 'telemetry' && (
              <div className="p-4 rounded-xl bg-zinc-900 border border-zinc-800 space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div key="GLOBAL TAIL ROSTER" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">GLOBAL TAIL ROSTER</span>
                      <p className="text-lg font-bold text-amber-400 font-mono mt-0.5">{"38 AIRCRAFT"}</p>
                    </div>
                  
                    <div key="EMPTY-LEG SAVINGS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">EMPTY-LEG SAVINGS</span>
                      <p className="text-lg font-bold text-amber-400 font-mono mt-0.5">{"UP TO 65%"}</p>
                    </div>
                  
                    <div key="PART 135 SAFETY RATING" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">PART 135 SAFETY RATING</span>
                      <p className="text-lg font-bold text-amber-400 font-mono mt-0.5">{"ARGUS PLATINUM"}</p>
                    </div>
                  
                    <div key="DISPATCH READINESS" className="p-3 rounded-lg bg-zinc-950 border border-zinc-800">
                      <span className="text-xs text-zinc-500 font-mono">DISPATCH READINESS</span>
                      <p className="text-lg font-bold text-amber-400 font-mono mt-0.5">{"< 2 HOURS"}</p>
                    </div>
